        ...
        <div class="info-grid">
          <div class="info-item">
            ...
            <div class="username-edit">
              ...
              <el-input v-else v-model="editUsernameValue" size="small"
                :placeholder="$t('userSettings.accountInfo.usernamePlaceholder')" style="width: 200px;" />
              <el-button v-if="!editingUsername" type="text" size="small" @click="startEditUsername">
              ...
              <div v-else class="username-actions">
                ...
                <el-button size="small" @click="cancelEditUsername">
          ...
          <div class="info-item">
            ...
            <div class="phone-edit">
              ...
              <el-input v-else v-model="editPhoneValue" size="small"
                :placeholder="$t('userSettings.accountInfo.phonePlaceholder')" style="width: 200px;" />
              <el-button v-if="!editingPhone" type="text" size="small" @click="startEditPhone">
                {{ $t('userSettings.accountInfo.edit') }}
              </el-button>
              <div v-else class="phone-actions">
                <el-button type="primary" size="small" :loading="savingPhone" @click="savePhone">
                  {{ $t('userSettings.accountInfo.save') }}
                </el-button>
                <el-button size="small" @click="cancelEditPhone">
                  {{ $t('userSettings.accountInfo.cancel') }}
                </el-button>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    goToFavorites() {
      navigateTo('/FavoritesManagement');
    },
    
    goToBrowsingHistory() {
      navigateTo('/BrowsingHistory');
    },
