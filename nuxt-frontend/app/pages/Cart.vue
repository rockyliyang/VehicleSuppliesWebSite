      ...
      <div class="cart-content" v-loading="loading">
        <div v-if="cartItems.length > 0" class="cart-items">
            ...
            <table class="cart-table">
              ...
              <tbody>
                <tr v-for="item in cartItems" :key="item.id" class="cart-table-row">
                  ...
                  <td class="product-cell">
                    <div class="product-info">
                      ...
                      <div class="product-details">
                        <NuxtLink :to="`/product/${item.product_id}`" class="product-name">
                          {{ item.product_name }}
                        </NuxtLink>
                  ...
                  <td class="price-cell">{{ $store.formatPrice(item.calculatedPrice || item.price) }}</td>
                  ...
                  <td class="subtotal-cell">{{ $store.formatPrice((item.calculatedPrice || item.price) *
                    item.quantity) }}</td>
                </tr>
              </tbody>
            </table>
            ...
            <div v-for="item in cartItems" :key="item.id" class="cart-card">
              <div class="card-header">
                ...
                <div class="product-info-mobile">
                  ...
                  <div class="product-details-mobile">
                    <NuxtLink :to="`/product/${item.product_id}`" class="product-name-mobile">
                      {{ item.product_name }}
                    </NuxtLink>
              ...
              <div class="card-body">
                <div class="price-info">
                  ...
                  <span class="price-value">{{ $store.formatPrice(item.calculatedPrice || item.price) }}</span>
                </div>
                ...
                <div class="subtotal-info">
                  ...
                  <span class="subtotal-value">{{ $store.formatPrice((item.calculatedPrice || item.price) *
                    item.quantity) }}</span>
                </div>
              </div>
              <!-- 移除手机端单个商品的删除按钮 -->
          ...
          <div class="cart-summary">
            <div class="cart-total">
              ...
              <span class="total-price">{{ $store.formatPrice(selectedTotal) }}</span>
            </div>
        ...
        <div v-else class="empty-cart">
          <div class="empty-cart-content">
            ...
            <button class="go-shopping-btn" @click="navigateTo('/Products')">
