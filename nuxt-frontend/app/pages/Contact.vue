...
export default {
  ...
  async setup() {
    ...
    try {
      ...
      const { data: ssrData } = await useAsyncData('contact-page', async () => {
        // 获取公司信息
  ...
  head() {
    return {
      title: this.$t('contact.page.title') || 'Contact Us',
      meta: [
        { hid: 'description', name: 'description', content: this.$t('contact.page.description') || 'Contact us for any inquiries about our automotive supplies and services.' },
        { hid: 'keywords', name: 'keywords', content: 'contact, automotive supplies, customer service, inquiry' },
        { property: 'og:title', content: this.$t('contact.page.title') || 'Contact Us' },
        { property: 'og:description', content: this.$t('contact.page.description') || 'Contact us for any inquiries about our automotive supplies and services.' },
