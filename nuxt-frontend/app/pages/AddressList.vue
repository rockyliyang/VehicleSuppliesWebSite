<template>
  <div class="address-list">
        ...
        <div v-for="address in addresses" :key="address.id" class="address-card"
          ...
          <div class="address-info">
            ...
            <div class="field-row">
              ...
              <span class="field-value">{{ getStateName(address.country, address.state) || address.state || '-'
                }}</span>
            </div>
            <div class="field-row">
    ...
    <!-- 地址对话框 -->
    <AddressDialog v-model="dialogVisible" :address-data="currentAddress" :countries="countries"
      :states-data="statesData" @success="handleDialogSuccess" />
  </div>
</template>
...
// import { mapGetters, mapActions } from 'vuex' // 移除vuex导入
...
export default {
  ...
  computed: {
    ...
    countries() {
      return this.$store.location.countries
    },
    statesData() {
      return this.$store.location.statesData
    },
  ...
  methods: {
    async loadCountryStateData() {
      await this.$store.location.loadCountryStateData();
    },
    ...
    getCountryName(countryCode) {
      return this.$store.location.getCountryName(countryCode);
    },
