      ...
      <div class="news-detail-content">
        ...
        <div class="main-content">
          ...
          <div v-else class="no-content">
            ...
            <h3>{{ $t('new.contentNotFound') }}</h3>
            <p>{{ $t('news.contentNotFoundDesc') }}</p>
...
export default {
  ...
  computed: {
    ...
    lang() {
      ...
      return $store.language.currentLanguage || 'zh-CN';
    },
  ...
  methods: {
    ...
    // 获取当前导航名称
    getCurrentNavName() {
      if (!this.navList || !this.currentNavId) return '';
